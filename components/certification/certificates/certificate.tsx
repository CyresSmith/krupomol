...
export const Certificate = ({ index, item }: Props) => {
    ...
    return (
        <div
            className={cn(
                'flex flex-col items-center gap-5 rounded-20 bg-accent px-4 py-6 shadow-lg desktop:w-[70%] desktop:flex-row desktop:gap-6 desktop:rounded-40 desktop:px-8 desktop:py-3',
