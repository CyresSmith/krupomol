...
const Advantage = ({ icon, text, title }: AdvantageType) => {
    return (
        <li className="grid w-full grid-cols-[44px,1fr] gap-8 rounded-40 bg-primary px-3 py-8 text-background mobile:gap-3 mobile:rounded-20 tablet:px-8 desktop:grid-cols-[70px,1fr] desktop:gap-8 desktop:px-20 desktop:py-12">
