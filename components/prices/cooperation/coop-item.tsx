...
export const CoopItem = ({ item }: Props) => {
    ...
    return (
        <li className="duration-150 linear flex w-full items-center gap-3 rounded-20 bg-primary fill-transparent stroke-accent px-3 py-12 text-white transition hover:scale-[1.01] desktop:gap-4 desktop:px-6">
